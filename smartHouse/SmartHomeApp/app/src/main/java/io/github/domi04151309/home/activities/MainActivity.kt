...
class MainActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val electricityButton: MaterialButton = findViewById(R.id.Electricity)
        val waterButton: MaterialButton = findViewById(R.id.Water)
    ...
    fun onElectricityButtonClick(view: View) {
        val intent = Intent(this, ElectricityActivity::class.java)
        startActivity(intent)
    ...
    fun onWaterButtonClick(view: View) {
       val intent = Intent(this, WaterActivity::class.java)
      startActivity(intent)
    }
